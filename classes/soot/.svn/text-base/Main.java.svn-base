...
//    	args = new String[]{"-soot-class-path", "src/pack/", "ClasseDependente"};
//    	
//        try {
//            Main.v().run(args);
...
//        }
    	...
    	System.out.println(Main.v().getDependences("BaseController", "../ferramentaLPS/Exemplo/02/comSorting/src/lancs/mobilemedia/core/ui/controller/"));
    	System.out.println(Main.v().getDependences("BaseController", "../ferramentaLPS/Exemplo/02/comSorting/src/lancs/mobilemedia/core/ui/controller/"));
    	
    }
    
    public Collection<String> getDependences(String classe, String path) {
    	G.v().reset();
    	
    	String[] comando = new String[]{"-soot-class-path", path, classe};
    	
    	return this.getDependences(comando);
    }
    
    public Collection<String> getDependences(String[] args) {
    	cmdLineArgs = args;
    	
    	Scene.dependencias.clear();
		...
		Collection<String> dependencias = new Vector<String>();
		dependencias.addAll(Scene.v().getDependencies());
